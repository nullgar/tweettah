...
class User(db.Model, UserMixin):
    ...
    def to_dict(self):
        return {
            ...
            'email': self.email,
            "followers": [{u.id:{"user_id": u.id, "user_name": u.username, "user_profile_pic": u.profile_pic}} for u in self.following],
            "following": [{u.id:{"user_id": u.id, "user_name": u.username, "user_profile_pic": u.profile_pic}} for u in self.followers],
